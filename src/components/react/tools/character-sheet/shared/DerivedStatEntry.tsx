...
export function DerivedStatEntry({
	...
	return (
		<div className="border-border border-b py-xs last:border-b-0">
			<div className="mb-0.5 text-text-muted text-xs uppercase tracking-tight-px">{label}</div>
			<div className="mt-[1px] text-text-muted text-xs tracking-[0.02em] opacity-70" id={formulaId}>
				{formulaText}
			</div>
			<div className="flex items-center gap-1">
				<span className="min-w-[22px] text-center text-sm text-text-dim" title="Base value">
					{baseValue}
				</span>
