							...
							return (
								...
								<WeaponRow key={`weapon-${idx}`}>
									...
									{isOpen && (
										<tr>
											<td
												className="border-border border-b bg-bg px-md py-sm"
												colSpan={colCount + 1}
											>
														...
														<div className="flex items-center gap-sm text-xs">
															...
															<label className="flex items-center gap-1 text-text-muted">
																...
																<NumberInput
																	min={0}
																	onChange={(v) =>
																		handleNumChange(idx, "attackDice", v)
																	}
																	value={extraAtkDice}
																/>
															</label>
															...
															<label className="flex items-center gap-1 text-text-muted">
																...
																<NumberInput
																	min={0}
																	onChange={(v) =>
																		handleNumChange(idx, "attackKeep", v)
																	}
																	value={extraAtkKeep}
																/>
															</label>
														...
														<div className="flex items-center gap-sm text-xs">
															...
															<label className="flex items-center gap-1 text-text-muted">
																...
																<NumberInput
																	min={0}
																	onChange={(v) =>
																		handleNumChange(idx, "damageDice", v)
																	}
																	value={baseDmgDice}
																/>
															</label>
															...
															<label className="flex items-center gap-1 text-text-muted">
																...
																<NumberInput
																	min={0}
																	onChange={(v) =>
																		handleNumChange(idx, "damageKeep", v)
																	}
																	value={baseDmgKeep}
																/>
															</label>
