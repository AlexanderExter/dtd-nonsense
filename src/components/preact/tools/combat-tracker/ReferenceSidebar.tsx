...
import { AccordionItem, Badge, Button, CloseButton } from "@/components/preact/ui";
	...
	return (
		<aside class={sidebarClasses}>
			<div class="flex justify-between items-center mb-sm">
				...
				<CloseButton class="hidden max-[1099px]:block" onClick={onClose} />
			</div>
			...
			<div>
				...
				<AccordionItem title="Hit Locations">
					...
					<Button size="sm" class="mt-sm" onClick={onRollLocation}>
						Roll Hit Location
					</Button>
					{hitLocationResult && (
