...
> **Open Question:** The SM must decide which version of Ghost Dice to use. The base version (good/bad side effects) may feel too unpredictable for some groups.
...
> **Open Question:** Check the Book 1 Flame weapon property for the breath weapon's TN. The SM must decide whether the TN is based on Ballistics or Dexterity.
