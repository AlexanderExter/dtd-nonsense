...
<CardGrid>
  <LinkCard title="Character Creation" href="/rules/02-char-creation/" description="Feat selection at Step 7" />
  <LinkCard title="Classes" href="/rules/06-classes/" description="Class feat lists" />
  <LinkCard title="Races" href="/rules/04-races/" description="Racial feat prerequisites" />
  <LinkCard title="Equipment" href="/rules/10-equipment/" description="Weapon/armor proficiency types" />
  <LinkCard title="Magic" href="/rules/11-magic/" description="Spell schools for magic feats" />
</CardGrid>
...
:::note
Feats marked with \* may be taken more than once. If the feat has groups, you must choose a different group each time.
:::
...
<details>
<summary>Full General Feats table (click to expand)</summary>
...
## Prerequisites: Alignment with a deity
...
## Prerequisites: At least 3 dots in a Magic School
...
## Prerequisites: At least 1 dot in a Magic School
