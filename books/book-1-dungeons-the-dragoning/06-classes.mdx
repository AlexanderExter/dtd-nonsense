...
Classes marked with an asterisk (*) are Level 1 classes and thus appropriate for a starting character:
Apprentice* - Someone who has just started on the path to mastering sorcery.
