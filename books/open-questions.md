...
- **Status:** Resolved — Used "Grand Hierophant" as it had the full definition. Applied in 06-Classes.md.
...
- **Status:** Resolved — Classes exist in other material; placeholdered in 06-Classes.md.
...
- **File:** 14-Combat.md, 07-Feats.md, 10-Equipment.md
...
- **Status:** Resolved — Each term is context-defined (Aura = magic, Armor = physical). Explicit note added in 14-Combat.md.

### Entry 5

- **File:** 14-Combat.md, 07-Feats.md
...
- **Status:** Resolved — (a) Wisdom replaces Dexterity only. Combat Sense description updated in 07-Feats.md to state "Wisdom replaces Dexterity for Dodge Tests."

### Entry 6

- **File:** 11-Magic.md, 06-Classes.md, 07-Feats.md
- **Location:** Spell Focus/Specialization
- **Issue:** Magic.md references both "Spell Focus" and "Spell Specialization." Classes require "Weapon Specialization OR Spell Specialization." Feats file only defined "Spell Focus" — no "Spell Specialization."
- **Interpretations:** (a) Same feat, inconsistent naming; (b) Two different feats, one undefined
- **Status:** Resolved — (b) Two distinct feats. Spell Specialization definition added to 07-Feats.md.

### Entry 7

- **File:** 05-Exaltations.md, 14-Combat.md, 07-Feats.md
...
- **Status:** Resolved — (a) Distinct pools with specific uses. The two systems are clearly separated in 05-Exaltations.md and 14-Combat.md.

### Entry 8

- **File:** 10-Equipment.md, 07-Feats.md, 06-Classes.md
...
- **Status:** Resolved — (a) One category chosen at time of gain. The feat's Choices list in 07-Feats.md implies selection from: Basic, Melee 1, Melee 2, Melee 3, Ranged 1, Ranged 2, Thrown.
...
- **Status:** Resolved — (a) Storm replaces, not additive. Explicit non-stacking note added in 14-Combat.md.

### Entry 10

- **File:** 19-Antagonists.md
...
- **Status:** Resolved — (b) Minions for mooks, full stats for named NPCs. Clarification note added in 22-GM-Reference.md.
...
- **File:** 06-Classes.md, 07-Feats.md
...
- **Status:** Resolved — Feat definitions extracted from source and added to 07-Feats.md.

### Entry 12

- **File:** 10-Equipment.md
...
- **File:** 03-Characteristics-Skills.md, 06-Classes.md, 07-Feats.md, and others
- **Location:** Throughout
- **Issue:** Inconsistent skill names: "Persuade" vs "Persuasion", "Performer" vs "Perform", "Ballistic" vs "Ballistics"
- **Interpretations:** Standardize to: Persuasion, Performer, Ballistics (per 03-Characteristics-Skills.md canonical definitions)
- **Status:** Resolved — Standardized across all processed-sources files including 04-Races.md.
...
- **Status:** Resolved — SD values recalculated and corrected in 17-Vehicles.md to match `SD = 10 + Maneuver - (2 × Size) + (Speed × Momentum Tier)`.
...
- **Status:** Resolved — No general rule exists in source material. Per-instance adjudication. Magic effects explicitly don't stack (11-Magic.md). Not editorialized beyond source.
...
- **Status:** Resolved — One Reaction per round (rules-stated). Free Actions at SM discretion (clarification note in 22-GM-Reference.md suggests 2-3 without question).
...
- **Status:** Resolved — (c) Defined per spell. Each magic school has a default characteristic listed in 11-Magic.md.

### Entry 19

- **File:** 05-Exaltations.md
...
- **Status:** Resolved — Each exaltation section in 05-Exaltations.md defines its own refresh timing.

### Entry 20

- **File:** 17-Vehicles.md, 18-Ships.md, 14-Combat.md
...
- **Status:** Resolved — (a) Scales don't interact directly. Clarification note in 22-GM-Reference.md.
...
- **Status:** Resolved — (b) Choose replacement. Clarification note added in 06-Classes.md.
...
- **Status:** Resolved — Each game event is discrete and sequential. SM determines order. No truly simultaneous actions. Clarification note in 22-GM-Reference.md.
...
- **Status:** Resolved — (c) Simplified values for SM convenience. NPC blocks use a simplified HP calculation for ease of reference, while player characters and Exalts use the full formula with doubling. Clarification note added in 19-Antagonists.md.

### Entry 40

- **File:** 12-Sword-Schools.md, 13-Gun-Kata.md
...
- **File:** book-2-for-a-few-subtitles-more/18-appendix-f-vehicles.md
...
- **File:** book-1-dungeons-the-dragoning/11-alignment.md, book-2-for-a-few-subtitles-more/10-alignment.md
