...
when, precisely, during a round a vehicle changes its position. If the vehicle is slow enough it can
...
to have the vehicle move 1/3 its movement at the start/end of the round, then 1/3 at the start of the
